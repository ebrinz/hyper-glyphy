"""
FastText Training: Train 768d skip-gram embeddings on cleaned Sanskrit corpus.
...
def train_fasttext(
    ...
    model_path = output_dir / "fasttext_sanskrit.model"
    vec_path = output_dir / "fasttext_sanskrit.vec"

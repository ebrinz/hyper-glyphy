...
- **2026-07-24 — Findings paper: Cross-Lingual Embedding Alignment for Six Ancient Languages, pre-registered findings from the 2026-07 arc.** Covers the eval-integrity reset, suite v2, the Sanskrit anchor-quality retirement verdict, and the K=5 myth study (band-edge Vṛtra↔Illuyanka positive, sumerian–sanskrit null). See [`docs/findings/hyper-glyphy-findings-2026-07.md`](docs/findings/hyper-glyphy-findings-2026-07.md) (markdown) / [`docs/findings/hyper-glyphy-findings-2026-07.pdf`](docs/findings/hyper-glyphy-findings-2026-07.pdf) (PDF).
- **2026-07-24 — Myth study K=5: Sanskrit fourth slot re-run on suite-v2 spaces; first adequately-powered Plane-B test returns a null (sanskrit-sumerian K=5, ρ=−0.33, p=0.77), Vṛtra-vs-Illuyanka positive control clears the ≥90th-pctile band (ρ=0.4, 90.55th).** All six slot-pair RSAs measured; Kumarbi control re-measured on v2 and reproduces v1 bit-for-bit (pure native-space Plane B, unaffected by the Ridge maps suite v2 changed); translation delta and concept fingerprints extended to Sanskrit; zero dropped docs. See journal 2026-07-24 entry.
